            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  <img src="./aset/logo.png" style="width: 185px;" alt="logo">
                    <div class= "judul">
                      <h4 class="mt-1 mb-5 pb-1">AYZA</h4>
                    </div>
                </div>
              ...
              <div class="form-row">
                <div class="col-lg-7">
                  <!-- name -->
                  <input type="text" class="form-control my-2 p-2" name="nama_pembeli" placeholder="Name" required>
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-7">
              ...
              <div class="form-row">
                <div class="col-lg-7">
                  <!-- No.telp -->
                  <input type="telp" class="form-control my-2 p-2" name="no_telp" placeholder="Telp" required>
                </div>
              </div>
              <div class="form-row">
                <div class="col-lg-7">
