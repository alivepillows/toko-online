<?php 
    ...
    //     /* Ambil id dan key */
    //     $id_pembeli = $_COOKIE['id_pembeli'];
    //     $key = $_COOKIE['key'];

    //     /* Ambil username berdasarkan id */
    //     $qry_login = mysqli_query($conn, "SELECT username FROM pembeli WHERE id_pembeli = $id_pembeli");
    ...
    if (isset($_POST["login"])){
        ...
        if(mysqli_num_rows($qry_login) > 0){
            ...
            */
            ...
            //         /* Buat Cookie */
            //         setcookie('id_pembeli', $dt_login['id_pembeli'], time()+60);
            //         /* Mengambil id_pembeli di tabel pembeli */
