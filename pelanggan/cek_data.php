            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach (@$_SESSION['cart'] as $key => $value) : 
                          ...
                          $grandtotal[]=$value["harga_barang"]*$value['qty'];
                        include '../koneksi.php';
                    ...
                    <tr>
                        <td><?=($key+1)?></td>
                        <td><img src="../foto_barang/<?=$dt_foto['foto_barang']?>" class="img-fluid rounded-start" alt="..." height="100px"></td>
                        <td><?=$value['nama_barang']?></td>
                        <td> <?php echo $value["harga_barang"]; ?></td>
                        <td><?=$value['qty']?></td>
                        <td> <?php echo number_format($value["qty"] * $value["harga_barang"], 2);?></td>
                    </tr>
                    <?php endforeach;?>
                </tbody>
            </table>
